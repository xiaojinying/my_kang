...
def init_config():
    ...
    # parser.add_argument('--config', type=str, default='mnist/lenet5/90',
    parser.add_argument('--config', type=str, default='cifar10/vgg19/99',
    ...
    parser.add_argument('--run', type=str, default='aaa', help='experimental notes (default: test_exp)')
    ...
    parser.add_argument('--debug', type=str, default='writer')  # 调试标记（打印数据和作图等）
    ...
    parser.add_argument('--prune_mode', type=str, default='dense',
                        help='prune mode (choose one of: dense, rank, rank/random, rank/iterative, force)')
